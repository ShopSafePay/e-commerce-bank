        ...
        <div className="mx-auto mt-10 w-full max-w-screen-xl px-4">
            ...
            <div className="flex flex-col justify-between lg:flex-row lg:flex-wrap">
                ...
                <div className="flex flex-col items-start lg:pr-16">
                    ...
                    <span className="mr-5 text-2xl">Business Consulting</span>
                    </h2>
                    <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl"> Leverage our expertise to strategize, streamline operations, and unlock your business's full potential for growth and success. </p>
                </div>
                </div>
                <div className="mt-8 lg:mt-10 lg:w-1/2">
                <div className="flex flex-col items-start lg:pr-16">
                    ...
                    <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl">
                    <span className="mr-5 text-2xl">Credit Card</span>
                    </h2>
                    <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Enjoy the convenience of secure transactions, flexible spending limits, and exclusive rewards, empowering you to make purchases with confidence.</p>
                </div>
                </div>
                <div className="mt-8 lg:mt-10 lg:w-1/2">
                <div className="flex flex-col items-start lg:pr-16">
                    ...
                    <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl">
                    <span className="mr-5 text-2xl">Income Monitoring</span>
                    </h2>
                    <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Empowering E-commerce Growth with Digital Banking Solutions Gain real-time visibility and insights into your income sources, empowering you to track, categorize, and optimize your earnings effortlessly.</p>
                </div>
                </div>
                <div className="mt-8 lg:mt-10 lg:w-1/2">
                <div className="flex flex-col items-start lg:pr-16">
                    ...
                    <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl">
                    <span className="mr-5 text-2xl">Financial Management</span>
                    </h2>
                    <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Take control of your finances with our comprehensive suite of tools and resources, enabling you to budget, track expenses, and achieve your financial goals effortlessly</p>
                </div>
                </div>
            </div>
        </div>
