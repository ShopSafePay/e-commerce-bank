        ...
        <div class="flex-auto p-6">
          ...
          <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
            <a href="#" class="flex cursor-pointer items-center gap-2 text-indigo-500 no-underline hover:text-indigo-500">
              <span class="flex-shrink-0 text-3xl font-black tracking-tight opacity-100">DogeBank</span>
            </a>
          </div>
          {/* <!-- /Logo --> */}
          {/* <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Welcome to Doge<span>Bank</span></h4> */}
          ...
          <form id="" class="mb-4" action="#" method="POST">
            ...
            <div class="mb-4">
              <div class="block">
                <input class="mt-1 mr-2 h-5 w-5 appearance-none rounded border border-gray-300 bg-contain bg-no-repeat align-top text-black shadow checked:bg-indigo-500 focus:border-indigo-500 focus:shadow" type="checkbox" id="remember-me" style={{backgroundImage: `url(&quot;data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M6 10l3 3l6-6'/%3e%3c/svg%3e&quot;)" checked`}} />
          ...
          <p class="mb-4 text-center">
            New on DogeBank?
            <a href="/pages/signup" class="cursor-pointer text-indigo-500 no-underline hover:text-indigo-500"> Create an account </a>
          </p>
        </div>
      </div>
      {/* <!-- /Register --> */}
